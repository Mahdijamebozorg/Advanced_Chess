...
#include <memory>
#include "../temp/Advanced_Chess/backend.hpp"
...
QT_MOC_LITERAL(1, 8, 7), // "getIcon"
QT_MOC_LITERAL(2, 16, 0), // ""
QT_MOC_LITERAL(3, 17, 6), // "choose"
QT_MOC_LITERAL(4, 24, 5) // "index"

    },
    "BackEnd\0getIcon\0\0choose\0index"
};
...
void BackEnd::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: { QString _r = _t->getIcon();
            if (_a[0]) *reinterpret_cast< QString*>(_a[0]) = std::move(_r); }  break;
        case 1: _t->choose((*reinterpret_cast< uint(*)>(_a[1]))); break;
        default: ;
        }
    }
}
